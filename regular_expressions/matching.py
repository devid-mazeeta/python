...
match3 = re.match(regex3, text3) # matches the regex pattern from the beginning of the given text
...
match4 = re.findall(regex4, text4, re.I) # finds all the matches and returns it in list
print(match4)
